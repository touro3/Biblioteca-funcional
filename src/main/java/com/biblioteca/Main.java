...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        usuarioService = new UsuarioService((UsuarioDAO) connection);


        // Carregar as configurações de conexão
    ...
    private static void redirecionarParaMenu(Usuario usuario, Scanner scanner) {
    ...
    private static void mostrarMenuAdministrador(@NotNull Scanner scanner, LivroService livroService, UserInputHandler userInputHandler, Usuario usuarioService) {
        int escolha = 0;
